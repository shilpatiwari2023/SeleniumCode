...
public class MultipleWindowHandle {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("(//a[@class='HomePageSectionHeader_homePageSectionHeader--cta__aRzJv '])")).click();

        // Wait for a moment to allow the new page to load
        Thread.sleep(2000);

        // Click on a specific course (Data Structures and Algorithms)
        driver.findElement(By.xpath("(//h4[text()=Data Structures and Algorithms - Self Paced [Online Course]")).click();
